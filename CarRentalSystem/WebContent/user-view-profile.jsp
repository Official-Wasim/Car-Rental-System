			...
			<div class="form-row">
				...
				<div class="form-group col-md-6">
					<label for="userId">User Id:</label> <input type="text"
						...
						name="userId" value="<%=resultset.getInt("userId")%>" readonly style="border: 1px solid #555;">
				</div>
				<div class="form-group col-md-6"">
					<label for="fullname">Full Name:</label> <input type="text"
						class="form-control" id="name" placeholder="Full Name"
						name="fullname" value="<%=resultset.getString("name")%>" style="border: 1px solid #555;">
				</div>
			</div>
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="email">Email Id:</label> <input type="text"
						...
						name="email" value="<%=resultset.getString("email")%>" style="border: 1px solid #555;">
				</div>
				<div class="form-group col-md-6">
					<label for="mobile">Mobile No:</label> <input type="text"
						class="form-control" id="mobile" placeholder="Mobile No"
						name="mobile" value="<%=resultset.getString("phone")%>" style="border: 1px solid #555;">
				</div>
			</div>
			<div class="form-row">
				<div class="form-group col-md-6">
				...
				<div class="form-group col-md-6">
					<label for="city">City:</label> <input type="text"
						...
						value="<%=resultset.getString("city")%>" style="border: 1px solid #555;">
				</div>
			</div>
			<%
				}
