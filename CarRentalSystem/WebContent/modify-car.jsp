...
<html lang="en">
    <head>
        ...
        <title> Modify Car | Car Rental System</title>
                    ...
                    <div class="col-md-offset-3 col-md-8">
                        ...
                        <form class="form-horizontal" method="POST" action="ModifyCarProcess" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="regNo" class="form-control" value="<%=rs.getString("regNo")%>" readonly="readonly" style="border: 1px solid #555;">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <textarea name="description" rows="3" class="form-control" style="border: 1px solid #555;"><%=rs.getString("description")%></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="rentalPrice" class="form-control" value="<%=rs.getString("rentalPrice")%>" style="border: 1px solid #555;"></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Status</label>
                                <div class="col-sm-4">
                                    <select class='form-control' name="active" style="border: 1px solid #555;">
                                        <option selected="true" disabled="disabled">- Select -</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <img src="<%=rs.getString("carImage")%>" class="img-responsive" style="border: 1px solid #555;">
                                    <input type="file" name="carImage" class="form-control" placeholder="Email" style="border: 1px solid #555;">
                                </div>
                            </div>
                            <div class="form-group">
