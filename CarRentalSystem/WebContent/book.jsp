...
<html lang="en">
    <head>
        ...
        <title>Book | Car Rental System</title>
            ...
            <div class="blog">
                <div class="row">
                    <div class="col-md-12">
                        <% if (session.getAttribute("userid") != null) {
                                ...
                                try {
                                    ...
                                    PreparedStatement ps = conn.prepareStatement("INSERT INTO "
                                            + "RentalRequest (userId, regNo, dateRequested, dateFrom, dateTo, status,totalRent) "
                                            + "VALUES (?, ?, ?, ?, ?, ?, ?) ");
                        ...
                        %>
                        <h4>Your booking has been submitted</h4>
                        <% } else { %>
