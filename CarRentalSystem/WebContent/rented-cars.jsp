				...
				<div class="col-md-12">
					...
					<table class="table table-condensed table-bordered">
						...
						<%
							...
							"SELECT * FROM RentalRequest, Car WHERE RentalRequest.regNo=Car.regNo AND RentalRequest.status LIKE ? AND Car.active NOT LIKE ? AND dateFrom >= ?");
						...
						<tr>
							...
							<td><%=rs.getString("rentalPrice")%> Rs/- 
							</td>
							<td><%=rs.getString("totalRent")%> Rs/- 
							</td>
						</tr>
						<%
							}
					...
					<div class="alert alert-danger" role="alert">
						<span class="glyphicon glyphicon-ok" aria-hidden="true"></span> <strong>
							Please login: </strong> You must be logged-in to view this page
					</div>
					<%
						}
					%>
